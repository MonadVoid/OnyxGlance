...
(defun casey-big-fun-c-hook ()
  ...
  (defun eric-markdown-format ()
     "Format the given file as a markdown file."
     (interactive)
     (setq BaseFileName (file-name-sans-extension (file-name-nondirectory buffer-file-name)))
     (insert "---")
     (insert "layout: post or page")
     (insert "title: My Post")
     (insert "slug: my-post")
     (insert "date: 2015-04-03 12:04:19")
     (insert "summary: a post that is mine")
     (insert "categories:")
     (insert "comments: true")
     (insert "author: Eric Faehnrich")
     (insert "---")
     (insert "<!-- more -->")
  )
  ...
  (cond ((file-exists-p buffer-file-name) t)
        ...
        ((string-match "[.]md" buffer-file-name) (eric-markdown-format))
